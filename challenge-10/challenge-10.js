(function(){
    ...
    */
    function isOperatorValid (operador){    
        ...
        // passando o valor boolean de return usando !! 
    ...
    */
    function calculator(operador){
        // sempre que usar uma validação boolean o metodos sempre usara no come "is" ou "res"
    ...
    */
    ...
    operadorSignal = "+";
    var sum = calculator (operadorSignal);
    ...
    */
    ...
    if(sum !== false){
        numero1 = 3;
        numero2 = 3;
        console.log( showOperationMessage(operadorSignal,numero1,numero2), sum (numero1,numero2 ) );
    }else{
        console.log(showErrorMessage(operadorSignal)); 
    }
    ...
    */
    ...
    operadorSignal = "-";
    var subtraction = calculator (operadorSignal);
    ...
    operadorSignal = "*";
    var multiplication = calculator (operadorSignal);
    ...
    operadorSignal = "%";
    var division = calculator (operadorSignal);
    ...
    */
    operadorSignal = "bia";
    var invalido = calculator (operadorSignal);
